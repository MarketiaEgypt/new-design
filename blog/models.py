...
class Post(models.Model):
    ...
    image_list = models.ImageField(upload_to='post/', blank=True, null=True)
    image_detail_head = models.ImageField(upload_to='post/', blank=True, null=True)
    ...
    description_blockquote = models.TextField()
